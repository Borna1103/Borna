        ...
        <nav className={`flex flex-wrap justify-between bg-slate-800 px-10 w-full py-8 `}>
              ...
              <ul className="flex  items-center">
                <li className='text-4xl flex sm:gap-10 gap-4 text-white '>
                  ...
                  <Link className=" transition duration-200 ease-in-out bg-gradient-to-r text-base from-teal-600 to-emerald-400 text-white px-4 py-2 rounded transform hover:scale-110 " href='https://drive.google.com/file/d/1arGy_pvBLR4m4TtuUIRyBAPaFWFlRV9q/view?usp=sharing' target='_blank'>
                    Resume
                  </Link>
                  <Link className=" transition duration-200 ease-in-out bg-gradient-to-r text-base from-purple-600 to-pink-400 text-white px-4 py-2 rounded transform hover:scale-110 " href='https://borna1103.github.io/2D-Portfolio/' target='_blank'>
                    2D Portfolio
                  </Link>
                </li>
              </ul>
